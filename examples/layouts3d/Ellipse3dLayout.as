package layouts3d
{
	...
	public class Ellipse3dLayout extends Sprite
	{
		...
		public function Ellipse3dLayout()
		{
			super();
			_layout = new Ellipse3d(LAYOUT_WIDTH-40, LAYOUT_HEIGHT-40, LAYOUT_DEPTH);
			_layout.x=LAYOUT_WIDTH/2, _layout.y=LAYOUT_HEIGHT/2; 
			Ellipse3d(_layout).rotationY=-20

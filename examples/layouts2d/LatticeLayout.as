package layouts2d
{
	...
	public class LatticeLayout extends Sprite
	{
		...
		public function LatticeLayout()
		{
			super();
			_layout = new Lattice(LAYOUT_WIDTH-40, LAYOUT_HEIGHT-40, 10, 10);
			Lattice(_layout).latticeType=LatticeType.DIAGONAL;

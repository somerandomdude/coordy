package layouts2d
{
	...
	public class ScatterLayout extends Sprite
	{
		...
		public function ScatterLayout()
		{
			super();
			_layout = new Scatter(LAYOUT_WIDTH-40, LAYOUT_HEIGHT-40);
			Scatter(_layout).jitterRotation=true;
